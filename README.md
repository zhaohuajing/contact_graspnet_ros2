...
- Note: 
	- If you pulled the docker image from docker hub instead of building it locally, modify `run_docker.sh`'s  `line 16` from `cuda118:contact_graspnet \ ` to `zhaohuajing/cuda118:contact_graspnet \ `. 
